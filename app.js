...
const pageRoutes = require('./api/pageRoutes'); // Import page routes
const userRoutes = require('./api/userRoutes');
const adminRoutes = require('./api/adminRoutes'); // Assuming you have admin routes
const showProducts= require('./api/show_products');
const app = express();
